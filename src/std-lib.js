...
export const standardLibrary = {
    ...
    io: {
        exscribe: core.importedFunction("io", "exscribe", core.functionType([core.anyType], core.voidType)),
    },

    typing: {
        typeof: core.importedFunction("typing", "typeof", core.functionType([core.anyType], core.stringType)),
    },

    function: {
        apply: core.importedFunction("function", "apply", core.functionType([core.anyType, core.anyType + "[]"], core.anyType + "[]")),
    },

    string: {
        supplant: core.importedFunction("string", "supplant", core.functionType([core.stringType, core.stringType, core.stringType], core.stringType)),
    },
};